...
public class ControllerLogin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        obFuncionario.setFuncionarioUsuLogin(request.getParameter("user"));
        obFuncionario.setFuncionarioUsuSenha(request.getParameter("password"));
        
        if(obFuncionario.verificaUsuario()==true){
