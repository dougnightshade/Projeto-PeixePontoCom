...
<%
    ...
    listaGaiola = obRegistraLotedepeixeDAO.ListarGaiolasDisponiveis();
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div>
            ...
            %>
            <div class="col-sm-3 min-640px-margin-top-1em" onclick="location = 'regeEntrLoteDePeixesPrincipal.jsp?codigo=<%=listaGaiola.get(index).getGaiolaCodigo()%>'">
