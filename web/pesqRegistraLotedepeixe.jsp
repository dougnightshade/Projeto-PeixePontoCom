...
<%
    ...
    List<RegistraLotedepeixe> listaRegistraLotedepeixe = obRegistraLotedepeixeDAO.listar();
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        <td class="text-center">
                                            <button class="btn btn-default col-xs-12 margin-bottom-0em margin-top-0em" onclick="location = 'infoRegistraLotedepeixe.jsp?codigo=<%=listaRegistraLotedepeixe.get(index).getRegistraLoteDePeixeCodigo() %>'">
                                        ...
                                        <td><%=obGaiola.getGaiolaCodigo()%></td>
