...
<%
    ...
    List<TipoFuncionario> listaTipoFuncionario = obTipoFuncionarioDAO.listarDiferentes(obTipoFuncionario);
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div>
            ...
            <!--div logo =================-->
            <form action="ControllerFuncionario" method="POST" autocomplete="off">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                           <a class="panel-div-back-button pointer efeito-botao"  onclick="history.go(-1)"><i class="fa fa-2x fa-reply"></i></a>
                            ...
                            <h4>Alteração do Funcionário: <%=obFuncionario.getFuncionarioNome()%></h4>
                            <div class="panel-footer text-left">
                                <span class="glyphicon glyphicon-barcode" aria-hidden="true"></span>
                                Código Funcionário: <%=obFuncionario.getFuncionarioCodigo()%>
                            </div>
                        </div>
                        <div class="fix-panel-body panel-body">
                            ...
                            <div class="col-xs-12">
                                <span id="sprytextfield1">
                                    ...
                                    <input type="text" name="inNome" id="inNome" required value="<%=obFuncionario.getFuncionarioNome()%>">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <span id="spryselect1">
                                    ...
                                    <select name="selTipoFuncionario" id="selTipoFuncionario" required="">
                                        <option value="<%=obTipoFuncionario.getTipoFuncionarioCodigo()%>"><%=obTipoFuncionario.getTipoFuncionarioDescricao()%></option>
                                        <%
                                            /*So para quebrar*/
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <span id="sprytextfield2">
                                        ...
                                        <input type="email" name="inEmail" id="inEmail" required value="<%=obFuncionario.getFuncionarioEmail()%>">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4">
                                            <span id="sprytextfield3">
                                                ...
                                                <input type="text" name="inLogin" id="inLogin" value="<%=obFuncionario.getFuncionarioUsuLogin()%>">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <span id="sprypassword1">
                                                ...
                                                <input type="password" name="inSenha" id="inSenha" autocomplete="off" value="<%=obFuncionario.getFuncionarioUsuSenha()%>">
                                                <span class="sobreescrito">No mínimo 6 caracteres</span><br>
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-xs-3 col-sm-2 col-lg-1" >
                                        <span id="sprytextfield6">
                                            ...
                                            <input type="text" name="inDddFixo" id="inDddFixo" value="<%=obFuncionario.getFuncionarioTelDddfixo()%>">
                                            <span class="textfieldInvalidFormatMsg">Formato inválido.</span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="col-xs-9 col-sm-3">
                                        <span id="sprytextfield4" >
                                            ...
                                            <input type="text" name="inTelefoneFixo" id="inTelefoneFixo" value="<%=obFuncionario.getFuncionarioTelFixo()%>" >
                                            <span class="textfieldInvalidFormatMsg">Formato inválido.</span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="col-xs-3 col-sm-2 col-lg-1">
                                        <span id="sprytextfield7">
                                            <label class="fix-fielset-label">DDD:</label>
                                            <input type="text" name="inDddCelular" id="inDddCelular" value="<%=obFuncionario.getFuncionarioTelDddcelular()%>">
                                    ...
                                    <div class="col-xs-9 col-sm-3">
                                        <span id="sprytextfield5">
                                            ...
                                            <input type="text" name="inTelefoneCelular" id="inTelefoneCelular" value="<%=obFuncionario.getFuncionarioTelCelular()%>">
                                            <span class="textfieldInvalidFormatMsg">Formato inválido.</span>
                                        </span>
                                    </div>
                                </fieldset>
                            ...
                            <!-- Inicio Area dos botoes Inferiores -->
                            <div>
                                <input type="hidden" name="pagina" value="alteFuncionario" />
                                <input type="hidden" name="inCodigoAlterar" value="<%=obFuncionario.getFuncionarioCodigo()%>" />
                                <%@include file="pdrBtnSalvarInferior.jsp" %>
                            </div>
                            <!-- Fim da Area dos botoes Inferiores -->
