...
<html lang="pt-br">
    ...
    <body>
        <form action="ControllerGaiola" method="POST">
            <input type="hidden" name="pagina" value="inutilizarGaiola" />
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Inutilizar Gaiola</h4>
                        </div>
                        <div class="modal-body">
                            Deseja realmente Inutilizar esta Gaiola?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="glyphicon glyphicon-thumbs-down"></i> Não</button>
                            <button type="submit" class="btn btn-default btn-danger"><i class="glyphicon glyphicon-thumbs-up"></i> Sim</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-sm-offset-6">
                                <button type="button" class="btn btn-default btn-block margin-top-1em" onclick="location = 'alteGaiola.jsp?codigo=<%=obGaiola.getGaiolaCodigo()%>'"><span class="glyphicon glyphicon-pencil"></span> Alterar</button>
                            </div>        
                            <div class="col-sm-3">
                                <button type="button" class="btn btn-default btn-block margin-top-1em" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-remove"></span> Inutilizar</button>   
                            </div>  
                        </div>
                        <!--Area dos botoes ==============--> 
                    </div> 
