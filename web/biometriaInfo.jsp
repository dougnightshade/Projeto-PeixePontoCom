...
<html lang="pt-br">
    <head>
        ...
        <title>Informações do Registro</title>     
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset>
                            ...
                            <div>
                                ...
                                <div class="col-xs-3">
                                    <span>
                                        <label>Etapa Biometrica</label>
                                        <input type="text" name="inCusto" value="<%=obBiometriaPeixeItem.getBiometriaPeixeItemNumeroEtapa() %>" readonly="" />
                                        <span></span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-3">
                                    <span>
                                        <label>Custo</label>
                                        <input type="text" name="inCusto" value="<%=obRegistraLotedepeixe.getRegistraLoteDePeixeCustoLote().toString().replace(".", ",")%>" readonly="" />
                                        <span></span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-3">
                                    <span>
                                        ...
                                        <%
                                        BigDecimal obQtd;
                                        obQtd = BigDecimal.valueOf(obRegistraLotedepeixe.getRegistraLoteDePeixeQuantidade());
                                        %>
                                        <input type="text" name="inQtdPeixes" value="<%=obQtd.setScale(2, RoundingMode.UP).toString().replace(".", ",") %> Peixes" readonly="" />
                                        <span></span>
                                    </span>
                                </div>
                            ...
                            <div class="col-xs-4">
                                <span>
                                    ...
                                    <input type="text" name="inDataDeRegistro" value="<%=obBiometriaPeixeItem.getBiometriaPeixeItemTaxaArracoamento().toString().replace(".", ",")%>kg" readonly="" />
                                    <span></span>
                                </span>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-4">
                                    <span>
                                        ...
                                        <input type="text" name="inTotalAream3" value="<%=obGaiola.getGaiolaTamTotalM3().toString().replace(".", ",") %>m³" readonly="" />
                                        <span></span>
                                    </span>
                                </div>
                                <div class="row"> 
                                    <div class="col-xs-3">
                                        ...
                                        <input type="text" name="inComprimeto" value="<%=obGaiola.getGaiolaTamComprimento().toString().replace(".", ",") %>m" readonly="readonly" />
                                    </div>
                                    <div class="col-xs-3">
                                        ...
                                        <input type="text" name="inComprimeto" value="<%=obGaiola.getGaiolaTamAltura().toString().replace(".", ",") %>m" readonly="readonly" />
                                    </div>
                                    <div class="col-xs-2    ">
                                        ...
                                        <input type="text" name="inComprimeto" value="<%=obGaiola.getGaiolaTamLargura().toString().replace(".", ",") %>m" readonly="readonly" />
                                    </div>
                                </div>
                            </div>
